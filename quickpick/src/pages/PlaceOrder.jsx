...
const PlaceOrder = () => {
  ...
  return (
    <form onSubmit={handleClick} className='flex flex-col sm:flex-row justify-between gap-4 pt-5 mb-60 sm:pt-14 min-h[80vh] border-t '>
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
        ...
        <textarea onChange={handleChange} name='address' value={formData.address} placeholder="Address" className="w-full border border-gray-300 rounded-md px-4 py-2" />
